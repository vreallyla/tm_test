@props(['label', 'required' => false, 'name', 'disabled' => false, 'value' => null])
<div>
    ...
    <textarea @disabled($disabled) @if ($required) required @endif name="{{ $name }}"
        id="{{ $name }}" placeholder="{{ $disabled ? '' : 'isi ' }}{{ $label }}..."
        @class([
